...
(function() {
  var Action, appendArgs, ignore, makeNodeCb, makeQueryStrR;
  ...
  Action.chain = function(monadicActions) {
    return function(init) {
      var a, j, len1, monadicAction, ref;
  ...
  Action.parallel = function(actions, stopAtError) {
    ...
    return new Action(function(cb) {
      var action, i, j, len1, results1;
      if (countDown > 0) {
        results1 = [];
        for (i = j = 0, len1 = actions.length; j < len1; i = ++j) {
          action = actions[i];
  ...
  Action.sequence = function(actions, stopAtError) {
    var a, action, countDown, fn1, j, len1, ref, results;
    if (stopAtError == null) {
      stopAtError = false;
    }
    results = [];
  ...
  appendArgs = function(target, appendee) {
    var len, ret;
    len = target.length;
    ret = new Array(len + 1);
    ret[len] = appendee;
  ...
  Action.makeNodeAction = function(nodeAPI) {
    return function() {
      ...
      args = arguments;
      return new Action(function(cb) {
        return nodeAPI.apply(self, appendArgs(args, makeNodeCb(cb)));
      });
    };
  };
