...
(function() {
  var Action, appendArgs, fireByResult, makeNodeCb, makeQueryStrR;
  ...
  Action.join = function(action1, action2, cb2) {
    return new Action(function(cb) {
      ...
      return action1._go(function(data) {
        result2 = data;
        countDown--;
        if (countDown === 0) {
          return fireByResult(cb, cb2(result1, result2));
  ...
  Action.race = function(actions, stopAtError) {
    ...
    return new Action(function(cb) {
      var action, countDown, i, j, len, results1, returns;
